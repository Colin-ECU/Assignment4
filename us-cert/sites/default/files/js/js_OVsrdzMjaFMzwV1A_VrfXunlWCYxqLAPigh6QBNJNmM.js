    ...
    Drupal.behaviors.homepage = {
        attach: function (context, settings) {
            jQuery(document).ready(function(){
                if(jQuery('#views-bootstrap-us-cert-current-activity-nd-home-block', context).length > 0)
                {
                    var $i = 0;
                    jQuery('#views-bootstrap-us-cert-current-activity-nd-home-block .row div.col').each(function(){
                            $i++;
                            if(2 == $i)
                            {
                                jQuery(this).after('<div class="clearfix visible-md"></div>');
                            }
                            });
                }
             });
